...
FORECASTS_CSV_COLUMNS = [
    ...
    "market_devig_probabilities_H", "market_devig_probabilities_D", "market_devig_probabilities_A",
        ...
        rows.append(
            {
                ...
                "market_devig_probabilities_H": _get(s, "market_devig_probabilities", "H"),
                "market_devig_probabilities_D": _get(s, "market_devig_probabilities", "D"),
                "market_devig_probabilities_A": _get(s, "market_devig_probabilities", "A"),
